...
(function () {
  ...
  var CH = {
    ...
    g6c1: { t: "السادس العلمي — الفصل الأول: المتسعات", em: "🔷" },
    g6c2: { t: "السادس العلمي — الفصل الثاني: الحث الكهرومغناطيسي", em: "🧲" },
    g6c3: { t: "السادس العلمي — الفصل الثالث: التيار المتناوب", em: "🌊" },
    g6c4: { t: "السادس العلمي — الفصل الرابع: الموجات الكهرومغناطيسية", em: "📡" },
    g6c5: { t: "السادس العلمي — الفصل الخامس: البصريات الفيزيائية", em: "🌈" },
    g6c6: { t: "السادس العلمي — الفصل السادس: الفيزياء الحديثة", em: "🔬" },
    g6c7: { t: "السادس العلمي — الفصل السابع: إلكترونيات الحالة الصلبة", em: "🔌" },
    g6c8: { t: "السادس العلمي — الفصل الثامن: الأطياف الذرية والليزر", em: "⚛️" },
    g6c9: { t: "السادس العلمي — الفصل التاسع: الفيزياء النووية", em: "☢️" }
  };
  // هوية لونية لكل فصل — يجب أن تبقى مطابقة لقيم --cc في
  // css/style.css (.chcard[data-ch] و.chcard.tile) حتى يرى الطالب نفس ألوان خريطة الفصول
  var CH_COLOR = {
    ch0: "#ea34cb", ch1: "#725be6", ch2: "#e63d37", ch3: "#0ea026", ch4: "#08af78",
    ch5: "#db7706", ch6: "#2466eb", ch7: "#b23bed", ch8: "#45a216", ch9: "#02a4c5",
    g6c1: "#4338ca", g6c2: "#b91c1c", g6c3: "#a21caf", g6c4: "#0369a1", g6c5: "#7c3aed",
    g6c6: "#0f766e", g6c7: "#b45309", g6c8: "#be123c", g6c9: "#15803d"
  };
  ...
  function renderReportCard(data) {
    ...
    return Promise.all([ensureFonts(), loadImage(assetURL("../assets/logo-ar.png"))])
      .then(function (res) {
        ...
        ctx.fillText("فيزياء أ. أحمد رافع · 📞 07800155157", fCx, fY + 82);
        ctx.fillStyle = violetDeep;
